...
class ArticleServiceTest {
    ...
    @Test
    void giveArticleInfo_whenSavingArticle_thenSavesArticle(){
        // Given
        given(articleRepository.save(any(Article.class))).willReturn(null);

        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "Khm", "title", "content", "#hashtag"));
    ...
    @Test
    void giveArticleIdAndModifiedInfo_whenUpdatingArticle_thenUpdatesArticle(){
        // Given
        given(articleRepository.save(any(Article.class))).willReturn(null);
    ...
    @Test
    void giveArticleId_whenDeletingArticle_thenDeletesArticle(){
        // Given
